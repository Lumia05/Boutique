...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Route correcte pour le contenu du modal d'édition produit (sans double /admin)
    Route::get('/products/{product}/edit-modal', [AdminProductController::class, 'editModal'])->name('products.edit-modal');
